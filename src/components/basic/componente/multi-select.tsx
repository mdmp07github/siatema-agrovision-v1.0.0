...
function MultiSelectContent({ children, className, selectedValues: _selectedValues, onChange: _onChange, ...props }: any) {
  return (
    <PopoverContent className={cn("p-0 w-(--radix-popover-trigger-width)", className)} {...props}>
      <Command>
