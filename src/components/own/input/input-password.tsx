  ...
  if (loading) {
    ...
    return (
      <div className={`relative w-full ${className}`}>
        ...
        />
        {valueEye ? (
          <><EyeOff className={`absolute top-0 right-0 ${label ? "mt-[35.5px]" : "mt-[6.5px]"} ${info ? "mt-[35.5px]" : "mt-[6.5px]"} mr-2 hover:opacity-80 active:opacity-70 cursor-pointer ${disable ? "pointer-events-none opacity-70" : ""} h-5 w-5`} onClick={() => on_click_eye()} /></>
        ) : (
          <><Eye className={`absolute top-0 right-0 ${label ? "mt-[35.5px]" : "mt-[6.5px]"} ${info ? "mt-[35.5px]" : "mt-[6.5px]"} mr-2 hover:opacity-80 active:opacity-70 cursor-pointer ${disable ? "pointer-events-none opacity-70" : ""} h-5 w-5`} onClick={() => on_click_eye()} /></>
        )}
      </div>
    )
  }
